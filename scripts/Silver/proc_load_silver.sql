...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            TRIM(cst_lastname),
            CASE
                WHEN UPPER(TRIM(cst_martia_status)) = 'S' THEN 'Single'
                WHEN UPPER(TRIM(cst_martia_status)) = 'M' THEN 'Married'
                ELSE 'N/A'
            END,
            CASE
        ...
        SELECT
            ...
            CASE
                WHEN TRY_CONVERT(INT, sls_sales) IS NULL
                     ...
                     OR TRY_CONVERT(INT, sls_sales) <>
                        ...
                        ABS(TRY_CONVERT(INT, sls_price))
                THEN TRY_CONVERT(INT, sls_quantity) *
                     ABS(TRY_CONVERT(INT, sls_price))
            ...
            CASE
                ...
                THEN TRY_CONVERT(INT, sls_sales) /
